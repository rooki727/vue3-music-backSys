...
import { addPlaylistSongAPI } from '@/apis/playlist'
// 弹框功能设置
const props = defineProps(['dialogFormVisible', 'title', 'clickRow', 'cannotInpId', 'playList_id'])
...
<template>
  ...
  >
    <el-form :model="addform" :rules="rules" ref="addFormRef">
      ...
      <el-form-item label="新的歌曲文件" label-width="8.75rem" prop="file">
        <div>
          <!-- 上传组件 -->
          <el-upload
            class="upload-demo"
